...
export const handler: Handlers<typeof config> = async ({ slug, mimeType, projectSlug, resolutionLabel, aspectRatio, coverWidth, coverHeight, duration, traceId }, { logger }) => {
