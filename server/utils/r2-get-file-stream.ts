...
export default async function (client: AwsClient, objectKey: string, endpoint = process.env.NITRO_PRIVATE_CDN_R2_ENDPOINT!, bucket = process.env.NITRO_PRIVATE_CDN_R2_BUCKET!) {
